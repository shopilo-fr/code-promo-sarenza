#!/usr/bin/env python3
"""
Recuperation des codes promo Sarenza depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/sarenza.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/sarenza.com"
STORE_NAME = "Sarenza"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Sarenza depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-sarenza)"
    }
    try:
